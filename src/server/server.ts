...
app.get('/api/results', (req, res) => {
  ...
  const previousResults = listPreviousResults(undefined /* limit */, filterDescription, datasetId);
  res.json({
...
export function startServer(port = 15500, browserBehavior = BrowserBehavior.ASK, filter?: string) {
  filterDescription = filter ?? undefined;
  httpServer
    .listen(port, () => {
